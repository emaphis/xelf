...
;; ;;; Custom data entry for Shell. See also entry.lisp 
...
;; (define-method evaluate-here shell-prompt ()
;;   (prompt%enter self))
...
;; (defparameter *shell-rows* 10)

;; (define-method accept shell (input &optional prepend)
...
;; 	(when (> len *shell-rows*)
;; 	  (dolist (item (subseq inputs *shell-rows*))
